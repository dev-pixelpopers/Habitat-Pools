...
import type { ProjectsPageContentData } from "@/lib/projects-page";
...
const FALLBACK = {
  banner: {
    ...
    backgroundImage: "/images/projects-banner.jpg",
  },
  cta: {
    ...
    <div className="app">
      ...
      >
        ...
        <div className="relative z-10 w-full px-[85px] pb-[80px]">
          ...
          <h1
            ref={headingRef}
            className="text-white text-[96px] leading-[88px] max-w-[900px] whitespace-pre-line"
          >
            {banner.heading}
          </h1>
        </div>
